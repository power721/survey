export default {
    ...
    survey: {
        ...
        options: '선택지',
        addOption: '선택지 추가',
        batchAddOptions: '일괄 추가',
        batchAddOptionsHint: '한 줄에 하나의 선택지를 입력하세요. 빈 줄은 건너뜁니다',
        batchAddOptionsPlaceholder: '선택지1\n선택지2\n선택지3',
        addedOptions: '{count}개의 선택지를 추가했습니다',
        publish: '게시',
        close: '마감',
        fill: '설문 작성',
        responses: '응답 목록',
        ...
        minOptions: '최소 선택 수',
        maxOptions: '최대 선택 수',
        minOptionsPlaceholder: '비워두면 제한 없음',
        maxOptionsPlaceholder: '비워두면 제한 없음',
        minValue: '최소값',
        maxValue: '최대값',
        minValuePlaceholder: '비워두면 제한 없음',
        maxValuePlaceholder: '비워두면 제한 없음',
        types: {
            SINGLE_CHOICE: '단일 선택',
    ...
    vote: {
        ...
        showVoters: '투표자 표시',
        endTimeRequired: '마감 시간을 설정해 주세요',
        atLeastOneOption: '최소 하나의 선택지가 필요합니다',
        atLeastTwoOptions: '최소 두 개의 선택지가 필요합니다',
        ...
        myVoteHistory: '내 투표 기록',
        voted: '투표함',
        selectedOption: '선택한 항목',
        viewPollDetails: '투표 세부정보 보기',
        noVoteHistory: '투표 기록이 없습니다',
        startCountdown: '시작까지',
        endCountdown: '종료까지',
        days: '일 ',
        hours: '시간 ',
    ...
    audit: {
        ...
        actions: {
            CREATE_SURVEY: '설문 생성',
            UPDATE_SURVEY: '설문 업데이트',
            DELETE_SURVEY: '설문 삭제',
            EXPORT_SURVEY: '설문 내보내기',
            CREATE_VOTE: '투표 생성',
            UPDATE_VOTE: '투표 업데이트',
            DELETE_VOTE: '투표 삭제',
            USER_LOGIN: '사용자 로그인',
